...
SELECT
    ...
    birth_de
FROM tb_emp
WHERE birth_de BETWEEN '19600101' AND '19741231'
INTERSECT
SELECT
    emp_no,
    emp_nm,
    birth_de
FROM tb_emp
WHERE birth_de BETWEEN '19640101' AND '19791231'
;
...
SELECT
    ...
    birth_de
FROM tb_emp
WHERE birth_de BETWEEN '19600101' AND '19791231'
MINUS
SELECT
    emp_no,
    emp_nm,
    birth_de
FROM tb_emp
WHERE birth_de BETWEEN '19680101' AND '19741231'
;
